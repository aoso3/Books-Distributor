 ...
 * @author Usama
 */
public class Author_View_Author_Books extends javax.swing.JFrame {
     ...
     */
    public Author_View_Author_Books() {
        initComponents();
        	...
        	new DefaultMutableTreeNode(" Books") {
        		{
        			...
        			DefaultMutableTreeNode node_1;
            			...
            			{
                			node_1 = new DefaultMutableTreeNode("Book: "+i++ +book.getTitle());
        			        add(node_1);
            			}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Author_View_Author_Books.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Author_View_Author_Books().setVisible(true);
            }
        });
    }
